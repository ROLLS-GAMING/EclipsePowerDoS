...
def random_phrase():
    ppl = ["EXLIPSE", "ECLIPSE", "EXLIPSE", "CYBEE-EXLIPSE", "PowerDDoSEclipse", "King•Eclipse", "Exlipse", "Exlipse", "Eclipse", "Exlipse"]
    phrase = ["Tools", "Ddos Attack", "Buatan", "Eclipse", "Jangan Di Gunakan", "Untuk Menyerang Situs", "NASA", "POLRI.GO.ID", "BIGETRON", "Dan Lain Lain"]
